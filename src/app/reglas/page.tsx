    ...
    <main className="relative min-h-screen bg-[#442d8e] text-white pb-16">
      ...
      <div className="relative max-w-sm mx-auto px-4 py-6 flex flex-col gap-8">
        ...
        <div>
          ...
          <p className="text-[#e0d0f8] text-xs mt-1">Mundial 2026</p>
        </div>
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="bg-[#2d1a5e] border border-white/10 rounded-xl overflow-hidden">
        ...
        <section className="flex flex-col gap-3">
          ...
          <div className="bg-[#2d1a5e] border border-white/10 rounded-xl overflow-hidden">
            {EXAMPLES.map(({ pred, pts, label }, i) => (
              ...
              >
                <span className="w-10 text-center font-mono text-sm text-[#e0d0f8] font-bold">
                  {pred}
                </span>
                <span className="flex-1 text-xs text-[#e0d0f8]">{label}</span>
                <span
          ...
          <div className="bg-[#2d1a5e] border border-white/10 rounded-xl overflow-hidden">
            {TIEBREAKERS.map((item, i) => (
              <div
                key={item}
                className={`flex items-center gap-4 px-4 py-3 ${
                  i < TIEBREAKERS.length - 1 ? "border-b border-white/10" : ""
                }`}
              >
                <span className="shrink-0 w-5 text-center text-[#c4a7f0] font-bold text-sm">
                  {i + 1}
                </span>
        ...
        <section className="bg-[#1e0e42] border border-white/20 rounded-xl px-4 py-4 flex flex-col gap-1">
          <h2 className="text-xs font-bold text-[#e0d0f8] uppercase tracking-widest">
