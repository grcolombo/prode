...
export default function MagicLinkForm() {
  ...
  if (status === "sent") {
    return (
      <div className="bg-white/5 border border-white/10 rounded-2xl px-4 py-4 text-center space-y-1">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      ...
      <button
        ...
        className="w-full border border-[#6b3db8]/60 text-[#9b6ee0] font-semibold py-3 rounded-2xl transition-all hover:bg-[#6b3db8]/10 active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed text-sm"
      >
